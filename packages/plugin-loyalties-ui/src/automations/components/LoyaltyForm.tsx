...
import { ControlLabel, FormControl, FormGroup, Icon } from "@erxes/ui/src";
...
const LoyaltyForm = (props: Props) => {
  ...
  const [showCustomConfig, setShowCustomConfig] = useState<boolean>(
    !!activeAction?.config?.customRule
  );
