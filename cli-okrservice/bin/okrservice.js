...
// `$ okrservice version` (--version synonym)
program
  .command("version")
  .description("output your version of okrservice")
  .action(() => {
...
program
  .command("dev")
  .description("Run okrservice in dev mode using pm2")
...
program
  .command("up")
  .description("Run okrservice using docker")
...
program
  .command("upgrade")
  .description("Download the latest changes of okrservice")
  .action(updateCmd);
