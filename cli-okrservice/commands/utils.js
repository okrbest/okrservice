...
module.exports.downloadLatesVersion = async configs => {
  ...
  await execCurl(
    "https://api.github.com/repos/okrbest/okrservice/releases/latest",
    "gitInfo.json"
  );
  ...
  await downloadFile(
    `https://github.com/okrbest/okrservice/releases/download/${gitInfo.tag_name}/erxes-${fileName}.tar.gz`,
    "build.tar.gz"
  );
