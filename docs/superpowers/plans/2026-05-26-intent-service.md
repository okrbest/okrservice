...
- [x] **Step 1: DB 모델 정의에 buttons 필드 추가**
...
- [x] **Step 2: GraphQL 스키마에 RpaButton 타입 + buttons 필드 추가**
...
- [x] **Step 1: index.ts 상단 import에 getIntentButtons 추가**
...
- [x] **Step 2: createRpaMessage 호출에 buttons 추가**
...
- [x] **Step 3: graphqlPubsub.publish 호출에 buttons 추가**
...
- [x] **Step 1: queries.ts의 rpaMessages 쿼리에 buttons 추가**
...
- [x] **Step 2: subscriptions.ts의 rpaMessageReceived 구독에 buttons 추가**
...
- [x] **Step 3: RpaMessage.tsx의 RpaMessageItem 타입에 buttons 추가**
...
- [x] **Step 1: RPA_BUTTON_MAP 상수 블록 삭제**
...
- [x] **Step 2: RPA 메시지 렌더링 블록에서 RPA_BUTTON_MAP 참조를 msg.buttons로 교체**
...
- [x] **Step 3: 버튼 onClick 핸들러도 확인 (path → url 조합)**
